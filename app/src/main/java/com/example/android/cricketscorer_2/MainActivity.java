package com.example.android.cricketscorer_2;
...
public class MainActivity extends AppCompatActivity
{
    ...
    public void enableTeamButtons()
    {
        if(whichTeamBatting)
        {
            findViewById(R.id.six_button_b).setEnabled(true);
            findViewById(R.id.four_button_b).setEnabled(true);
            findViewById(R.id.three_button_b).setEnabled(true);
            findViewById(R.id.two_button_b).setEnabled(true);
            findViewById(R.id.one_button_b).setEnabled(true);
            findViewById(R.id.extra_button_b).setEnabled(true);
            findViewById(R.id.wicket_button_b).setEnabled(true);
        }
        else
        {
    ...
    public void resetAll(View view)
    {
        ...
        zwitch.setEnabled(true);
        zwitch.setChecked(false);
        whichTeamBatting = false;
        TextView resetText = findViewById(R.id.battingTeam);
        resetText.setText(R.string.Ttoggle);
    ...
    public void gameOver(View view)
    {
        ...
        if(teamBScore > teamAScore)
            winner.setText(R.string.teambWin);
        else if(teamBScore < teamAScore)
            winner.setText(R.string.teambWin);
        else
            winner.setText(R.string.drawn);

        //disables buttons
        disableAllButtons();
        findViewById(R.id.gameOver_button).setEnabled(false);
        zwitch.setEnabled(false);
    }
    ...
    public void disableAllButtons()
    {
        ...
        findViewById(R.id.six_button_b).setEnabled(false);
        findViewById(R.id.four_button_b).setEnabled(false);
        findViewById(R.id.three_button_b).setEnabled(false);
        findViewById(R.id.two_button_b).setEnabled(false);
        findViewById(R.id.one_button_b).setEnabled(false);
        findViewById(R.id.extra_button_b).setEnabled(false);
        findViewById(R.id.wicket_button_b).setEnabled(false);
    }
}